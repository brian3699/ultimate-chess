...
public class DukeApplicationTest extends ApplicationTest {
    ...
    /**
     * Run given ooga.view method as a JFX action, allowing you to add/remove components from the Scene or Stage.
     */
    ...
    protected PieceInterface makePieceFromStream(int teamNum, char pieceKey, String type, Stream configuration, String path)
        ...
        try (InputStream input = ChessBoard.class.getClassLoader().getResourceAsStream(path)) {
            ...
            type = configuration.getData().get("Type").toString();
    ...
    private PieceInterface initializeReflectedPiece(
        ...
        try {
            Class<?> piece = Class.forName("ooga.model.piece." + type);
